            ...
            <div class="col-12 d-flex ">
                <div class="card flex-fill">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <a href="{{ route('formTambah2.projek') }}" class="btn btn-sm  my-0 rounded-3 primary-white">
                            Tambah Data
                        </a>
                        {{-- <h5 class="card-title mb-0">List Projek</h5> --}}
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <div class="d-flex justify-content-end">
                                        {{-- detail --}}
                                        <form class="d-inline-block mx-1" action="{{ route('detail2.projek', ['id' => $data['id'], 'sisaWaktu' => $sisaWaktu]) }}" method="get">
